...
<html lang="en">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
		<link rel="icon" href="images/yc.png" type="image/png" />
    <!--<link rel=“icon” type=“image/png” href=“http://example.com/image.png” />-->

    <title>Report Design and Advertisting</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" style="text-align:center;" class="site_title">
              <i class="fa fa-calculator"></i> <span>Report Design</span>
              </a>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a data-toggle="tooltip" data-placement="bottom" title="Report" onClick="javascript:searchreportyc();"><i class="fa fa-list-alt"></i> Report <!--<span class="fa fa-chevron-down"></span>--></a>
                  ...
                  <li>
                  <a data-toggle="tooltip" data-placement="bottom" title="Report" onClick="javascript:searchrepor_chart();">
                  <i class="fa fa-list-alt"></i> Report_Design </a>

                  </li>
                  <li>
                  <a data-toggle="tooltip" data-placement="bottom" title="Report" onClick="javascript:searchrepor_chart_emp();">
                  <i class="fa fa-list-alt"></i> Report_Emp </a>
                    ...
                    <ul class="nav child_menu">
											<li><a href="javascript:;" onClick="javascript:();">รถ <span class="fa fa-chevron-down"></span></a>
												<ul class="nav child_menu">
													...
													<li><a href="javascript:;" onClick="javascript:show_car2();">เพิ่มรถ</a></li>
													<li><a href="javascript:;" onClick="javascript:show_car();">ดูรถ</a></li>
		                    </ul>
											</li>
											<li><a href="javascript:;" onClick="javascript:();">สินค้า <span class="fa fa-chevron-down"></span></a>
												<ul class="nav child_menu">
													<li><a href="javascript:;" onClick="javascript:show_product();">เพิ่มค่ายกสินค้า</a></li>
													<li><a href="javascript:;" onClick="javascript:show_ratproduct();">ดูค่ายกสินค้า</a></li>
												</ul>
											</li>
                      <li><a href="javascript:;" onClick="javascript:();">พนักงาน <span class="fa fa-chevron-down"></span></a>
												<ul class="nav child_menu">
													<li><a href="javascript:;" onClick="javascript:show_preple();">เพิ่มพนักงาน</a></li>
													<li><a href="javascript:;" onClick="javascript:show_preple2();">ดูพนักงาน</a></li>
												</ul>
											</li>
											</ul>
                  </li>
