...
<script type="text/javascript" src="modul/report/loader.js"></script>
  ...
  <div class="" id="chart_div1"></div>
    ...
    //echo $month_1_Photo.' | '.$month_2_Photo.' | '.$month_3_Photo.' | '.$month_4_Photo.' | '.$month_5_Photo.' | '.$month_6_Photo.' | '.$month_7_Photo.' | '.$month_8_Photo.' | '.$month_9_Photo.' | '.$month_10_Photo.' | '.$month_11_Photo.' | '.$month_12_Photo;
    ...
    while( $row = mysql_fetch_array($result1)){
      ...
      //echo $month_3_Photo.' | '.$job_number.'<br>';
...
//    echo   $month_2_AdWebsite;
    ...
    $total_count=0;
      ...
      $total_count = $total_count+$COUNT;
        ...
        //echo 'M1'.' | '.$month_1_Handwork.' | '.$month1[5].' | '.$month_total[5].'<br>';
			}
			/////// Month 2
        ...
        //echo 'M2'.' | '.$month_2_Handwork.' | '.$month2[5].' | '.$month_total[5].'<br>';
			}
			/////// Month 3
        ...
        //echo $month_3_Photo.' | '.$month3[4].' | '.$month_total[4].'<br>';
			}else if($row['job_lv1']=="Handwork" && $MONTH=='3'){
        $month3[5]=$month_3_Handwork;
        $month_total[5]+=   $month3[5];
        //echo 'M3'.' | '.$month_3_Handwork.' | '.$month3[5].' | '.$month_total[5].'<br>';
			}
			/////// Month 4
        ...
        //echo 'M4'.' | '.$month_4_Handwork.' | '.$month4[5].' | '.$month_total[5].'<br>';
			}
			/////// Month 5
        ...
        //echo 'M5'.' | '.$month_5_Handwork.' | '.$month5[5].' | '.$month_total[5].'<br>';
			}
			/////// Month 6
        ...
        //echo 'M6'.' | '.$month_6_Handwork.' | '.$month6[5].' | '.$month_total[5].'<br>';
			}
			/////// Month 7
        ...
        //echo 'M7'.' | '.$month_7_Handwork.' | '.$month7[5].' | '.$month_total[5].'<br>';
			}
			/////// Month 8
        ...
        //echo 'M8'.' | '.$month_8_Handwork.' | '.$month8[5].' | '.$month_total[5].'<br>';
			}
			/////// Month 9
        ...
        //echo 'M9'.' | '.$month_9_Handwork.' | '.$month9[5].' | '.$month_total[5].'<br>';
			}
			/////// Month 10
        ...
        //echo 'M10'.' | '.$month_10_Handwork.' | '.$month10[5].' | '.$month_total[5].'<br>';
			}
			/////// Month 11
        ...
        //echo 'M11'.' | '.$month_11_Handwork.' | '.$month11[5].' | '.$month_total[5].'<br>';
			}
			/////// Month 12
        ...
        //echo 'M12'.' | '.$month_12_Handwork.' | '.$month12[5].' | '.$month_total[5].'<br>';
			}
		}
...
function drawMaterial() {
  var data = google.visualization.arrayToDataTable([
        ...
        ['รวม ('+<?php echo $month_total[0]+$month_total[1]+$month_total[2]+$month_total[3]+$month_total[4]+$month_total[5];?>+')',
        <?php echo $month_total[0];?>, <?php echo $month_total[1];?>, <?php echo $month_total[2];?>, <?php echo $month_total[3];?>, <?php echo $month_total[4];?>, <?php echo $month_total[5];?>,    ''],
